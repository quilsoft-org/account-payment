...
class AccountBankStatementLine(models.Model):
    ...
    def button_undo_reconciliation(self):
        ...
        for st_line in self:
            aml_to_unbind |= st_line.move_id.line_ids
            for line in st_line.move_id.line_ids:
                if st_line.move_id.name and line.payment_id.payment_reference \
                        == st_line.move_id.name:
        ...
        res = super().button_undo_reconciliation()
        if payment_groups:
