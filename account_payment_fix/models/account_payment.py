...
class AccountPayment(models.Model):
    ...
    # state = fields.Selection(track_visibility='always')    Obsolete in Odoo 14 ?
    # amount = fields.Monetary(track_visibility='always') Track visibility obsolete in Odoo 14?
    ...
    # @api.depends(
    #     'move_id.journal_id.outbound_payment_method_ids',
    #     'move_id.journal_id.inbound_payment_method_ids',
    #     'payment_type',
    # )   Check Method in Odoo 14
    # def _compute_payment_methods(self):
    #     for rec in self:
    #         if rec.payment_type in ('outbound', 'transfer'):
    #             methods = rec.move_id.journal_id.outbound_payment_method_ids
    #         else:
    #             methods = rec.move_id.journal_id.inbound_payment_method_ids
    #         rec.payment_method_ids = methods

    # @api.onchange('payment_type')
    # def _onchange_payment_type(self):  Obsolete in Odoo 14 ?
    #     """
    ...
    # def _compute_destination_account_id(self): Check method in Odoo 14
    #     """
